...
echo "${SLURM_JOB_ID},torch-spgemm,${SLURM_NTASKS},${SLURM_NTASKS_PER_NODE},${SLURM_CPUS_PER_TASK},${SLURM_MEM_PER_CPU}" >> $HOME/distributed-HGNNs/data/timing/mm_bench_hw.csv

$HOME/distributed-HGNNs/build/torch_spmatrix_bench -t "${TMPDIR}/" -i "${SLURM_JOB_ID}"
